...
public class BeerSongTest {
    ...
    @Test
    public void sing101thVerse() {
        assertThat(beerSong.sing(-1, 1)).isEqualTo("99 bottles of beer on the wall, 99 bottles of beer.\n" +
                "Take one down and pass it around, 98 bottles of beer on the wall.\n\n");
    }

    @Test
    public void singSecondVerse() {
        assertThat(beerSong.sing(98, 1)).isEqualTo("98 bottles of beer on the wall, 98 bottles of beer.\n" +
